...
<nav class=" border-b-2 border-gray-200 py-4 ">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Harpos</span>
    </a>
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
          <span class="sr-only">Open user menu</span>
          <img class="w-8 h-8 rounded-full" src="/images/product4.jpg" alt="user photo">
        </button>
        <!-- Dropdown menu -->
  ...
  <h1 class="text-3xl font-bold underline flex justify-center mt-20">Products</h1>
...
<section class="grid grid-cols-4 mt-10">
  ...
  <div class=" w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-4">
    <a href="/products/{{ $product->id }}">
        <img class="p-8 object-cover rounded-t-lg " src="/images/product1.jpg" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="/products/{{ $product->id }}">
        ...
        <div class="flex items-center mt-2.5 mb-5">
            {{-- Example static rating - you might want to make this dynamic --}}
            <div class="flex items-center space-x-1 rtl:space-x-reverse">
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">...</svg>
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">...</svg>
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">...</svg>
                <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">...</svg>
                <svg class="w-4 h-4 text-gray-200 dark:text-gray-600" aria-hidden="true" fill="currentColor" viewBox="0 0 22 20">...</svg>
            </div>
